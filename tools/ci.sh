...
function ci_esp32_build {
    ...
    make ${MAKEOPTS} -C ports/esp32 LV_CFLAGS="-DLV_COLOR_DEPTH=16 -DLV_COLOR_16_SWAP=1 -DLV_ILI9341_SHARE_SPI_BUS " USER_C_MODULES=../../../examples/usercmodule/micropython.cmake FROZEN_MANIFEST=$(pwd)/ports/esp32/boards/manifest.py
